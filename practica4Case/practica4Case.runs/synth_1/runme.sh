...
HD_PWD='C:/Users/luisr/Desktop/practica4Case/practica4Case.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Practica4Case.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Practica4Case.tcl
